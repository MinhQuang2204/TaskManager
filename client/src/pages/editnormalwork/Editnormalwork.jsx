...
const Editnormalwork = () => {
    ...
    // Tham chiếu đến phần tử chứa danh sách thảo luận
    ...
    const handleAddDiscussion = async (e) => {
        ...
        try {
            ...
            fetchDiscussions(); // Lấy lại danh sách thảo luận sau khi thêm mới
    ...
    // Cuộn xuống dưới cùng khi danh sách thảo luận thay đổi
    useEffect(() => {
            ...
            <div className='editnormalwork'>
                ...
                <div className='editnormalwork__right'>
                    ...
                    <div className='background'>
                        ...
                        <img src="/src/images/edit7.jpg" alt="background" />
                        {/* <img src="/src/images/edit6.jpg" alt="background" /> */}
                    </div>
